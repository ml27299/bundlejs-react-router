...
ifeq ($(shell git show-ref refs/heads/$(branch) | wc -l),0)
	git checkout -b $(branch)
else
ifeq ($(shell git show-ref refs/heads/$(branch) | wc -l),1)
	git checkout $(branch)
endif
endif
endif
ifneq ($(shell git ls-remote --exit-code origin $(branch) | wc -l),0)
